...
def top():
    ...
    #return GPIO.add_event_detect(top_pin, GPIO.FALLING, bouncetime=1000)
...
def bottom():
    ...
    #return GPIO.add_event_detect(bot_pin, GPIO.FALLING, bouncetime=1000)
...
def top_left():
    ...
    #return GPIO.add_event_detect(top_left_pin, GPIO.RISING, bouncetime=1000)
...
def bot_left():
    ...
    #return GPIO.add_event_detect(bot_left_pin, GPIO.RISING, bouncetime=1000)
